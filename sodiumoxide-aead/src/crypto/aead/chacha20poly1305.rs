...
//! ```
use ::ffi::{self, crypto_aead_chacha20poly1305_ietf_KEYBYTES};

aead_module!(
    ffi::crypto_aead_chacha20poly1305_ietf_encrypt,
    ffi::crypto_aead_chacha20poly1305_ietf_decrypt,
    ffi::crypto_aead_chacha20poly1305_ietf_KEYBYTES,
    ffi::crypto_aead_chacha20poly1305_ietf_NPUBBYTES,
    ffi::crypto_aead_chacha20poly1305_ietf_ABYTES);
...
mod test {
    ...
    fn test_canned_vector() {
        ...
        let n = Nonce([0xcd, 0x7c, 0xf6, 0x7b, 0xe3, 0x9c, 0x79, 0x4a, 0x22, 0x69, 0x18, 0xfe]);
