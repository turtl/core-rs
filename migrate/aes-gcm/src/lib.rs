...
#[cfg(feature = "aes")]
#[cfg_attr(docsrs, doc(cfg(feature = "aes")))]
// NOTE: AL: turtl js used a 16 byte tag because it was stupid. so here, we
// redefine the Aes256Gcm type (or, rather, replace it) to bend to our sick
// wishes. note that this is ONLY for migration, which is ONLY for decryption
// so whatever weird shit this does to ENcryption is kind of moot.
